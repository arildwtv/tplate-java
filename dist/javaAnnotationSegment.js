...
function javaAnnotationWithoutParameters(_ref, type) {
  var t = _ref.t;
...
function javaAnnotationSegment() {
  ...
  return function (tplate) {
    return args.length === 0 ? javaAnnotationWithoutParameters(tplate, type) : javaAnnotationWithParameters(tplate, type, args);
  };
}